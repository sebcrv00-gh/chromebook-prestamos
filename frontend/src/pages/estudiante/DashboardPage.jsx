...
import { PlusCircle, Clock, CheckCircle2, XCircle, Laptop } from 'lucide-react';
    ...
    <div>
      <div className="page-header">
        <div>
          ...
          <p className="page-subtitle">Portal de Estudiante — Solicita tu préstamo individual o de grupo de Chromebooks</p>
        </div>
        <button onClick={() => navigate('/estudiante/nueva-reserva')} className="btn btn-primary btn-lg">
          <PlusCircle size={20} />
          Solicitar Préstamo
        </button>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '1.25rem', marginBottom: '2rem' }}>
        <div className="stat-card" onClick={() => navigate('/estudiante/mis-reservas')} style={{ cursor: 'pointer' }}>
      ...
      <div className="card" style={{ marginBottom: '2rem' }}>
        <div className="card-header">
          <h3 className="card-title">Disponibilidad Actual de Equipos</h3>
        </div>
        {cartCycles.length === 0 ? (
      ...
      <div className="card">
        <div className="card-header">
          ...
          <button onClick={() => navigate('/estudiante/mis-reservas')} className="btn btn-secondary btn-sm">Ver Todas</button>
        </div>
          ...
          <table className="table">
            ...
            <tbody>
              {reservations.length === 0 ? (
                <tr><td colSpan="5" style={{ textAlign: 'center', color: 'var(--color-gray-400)' }}>Aún no has solicitado Chromebooks</td></tr>
              ) : (
