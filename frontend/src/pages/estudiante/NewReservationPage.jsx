...
export const EstudianteNewReservation = () => {
  ...
  return (
    <div>
      <div className="page-header">
        <div>
          <h1 className="page-title">Solicitar Préstamo de Chromebook</h1>
          <p className="page-subtitle">Ingresa los detalles para tu reserva de equipos</p>
        </div>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 340px', gap: '2rem', alignItems: 'start' }}>
        ...
        <div className="card">
          <form onSubmit={handleSubmit}>
              ...
              {cartCycles.length === 0 && (
                <div style={{
                  ...
                  <span>
                    ...
                    Por favor, contacta al administrador o profesor encargado.
                  </span>
                </div>
              )}
            </div>
            ...
            <div className="form-group">
              <label className="form-label">Materia / Actividad *</label>
              <input
                type="text"
                className="form-control"
                placeholder="Ej: Trabajo de Investigación de Robótica"
                value={purpose}
            ...
            <div className="form-group">
              ...
              <textarea
                className="form-control"
                rows="2"
                placeholder="Ej: Requiero equipos para el grupo 3"
                value={notes}
            ...
            <div style={{ display: 'flex', gap: '0.75rem', justifyContent: 'flex-end', marginTop: '1rem' }}>
              <button type="button" onClick={() => navigate('/estudiante')} className="btn btn-secondary">
                Cancelar
              </button>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          {availability ? (
            <div className="card">
              ...
              {availability.available <= 0 && (
                <div style={styles.warningBox}>
                  <AlertCircle size={16} />
                  <span>Sin stock libre disponible</span>
                </div>
              )}
            </div>
          ) : (
            <div className="card" style={{ textAlign: 'center', padding: '2rem' }}>
              ...
              <p style={{ color: 'var(--color-gray-400)', fontSize: '0.85rem', marginTop: '0.75rem' }}>
                Selecciona un kit de Chromebooks para consultar la disponibilidad en tiempo real
              </p>
            </div>
          )}
          ...
          <div style={styles.infoBox}>
            ...
            <p style={{ fontSize: '0.8rem', color: 'var(--color-gray-600)' }}>
              Recuerda devolver los equipos a tiempo al finalizar la hora especificada.
            </p>
          </div>
        </div>
      </div>
