...
export const DocenteMyReservations = () => {
  ...
  return (
    <div>
      <div className="page-header">
        <div>
          <h1 className="page-title">Mis Solicitudes de Chromebooks</h1>
          <p className="page-subtitle">Historial completo de todas tus solicitudes de préstamo</p>
        </div>
      </div>
      ...
      <div className="card" style={{ padding: 0 }}>
        <div className="table-container" style={{ border: 'none' }}>
          <table className="table">
            ...
            <tbody>
              {loading ? (
                <tr><td colSpan="7" style={styles.emptyCell}>Cargando solicitudes...</td></tr>
              ) : reservations.length === 0 ? (
                <tr><td colSpan="7" style={styles.emptyCell}>No has realizado solicitudes aún</td></tr>
              ) : (
                reservations.map((r) => {
                      ...
                      <tr style={{ cursor: 'pointer' }} onClick={() => setExpandedId(isExpanded ? null : r.id)}>
                        ...
                        <td>
                          ...
                          {r.quantityApproved != null && r.quantityApproved !== r.quantityRequested && (
                            <span style={{ fontSize: '0.7rem', color: 'var(--color-gray-500)', display: 'block' }}>
